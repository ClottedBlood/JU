...
public class PoweUpsManager : MonoBehaviour
{
    ...
    {
        maxPlatformsNumber = Random.Range(minPlatformsNumber, maxPlatformsNumber);
    }

    public void pPlatformPassed(Platform platform)
    {
        platformsCounter++;
